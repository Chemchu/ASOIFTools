                ...
                <div class="relative h-72 w-full overflow-hidden border rounded-lg bg-white text-gray-900 shadow-lg">
                    <div class="w-full h-full flex flex-col justify-center items-center">
                        <div class="flex w-full h-1/6 text-4xl sm:text-3xl text-gray-900 items-center justify-end pr-2">
                            ...
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" class="stroke-black fill-white size-6">
                        ...
                        <span class="flex w-full h-2/6 text-gray-900 text-4xl sm:text-3xl justify-center items-center "
