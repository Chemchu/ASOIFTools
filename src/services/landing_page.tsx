                    ...
                    <div>
                        <div class="relative">
                            <div class="relative h-72 w-full overflow-hidden rounded-lg">
                                <span class="h-full w-full text-9xl flex justify-center items-center">D6</span>
                            </div>
                            <div class="relative mt-4">
                                <h3 class="text-sm font-medium text-gray-900">Cantidad: </h3>
                                <p class="mt-1 text-sm text-gray-500">White and black</p>
                            </div>
                        </div>
                        <div class="mt-6">
                            <div class="cursor-pointer relative flex items-center justify-center rounded-md border border-transparent bg-gray-100 px-8 py-2 text-sm font-medium text-gray-900 hover:bg-gray-200"
                                x-on:click="$refs.dice_audio.play()"
                            >Roll<span class="sr-only">, Roll</span>
                            </div>
                        </div>
                    </div>
